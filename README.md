...
```bash
dotnet dev-certs https -v -ep authserver.pfx -p 7d90b8ca-aab2-48fd-80f5-d3c70463f023
```

> `7d90b8ca-aab2-48fd-80f5-d3c70463f023` is the password of the certificate, you can change it to any password you want.
